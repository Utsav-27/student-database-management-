...
class Student:
	def __init__(self, root):
		self.root=root
		self.root.title("MANAGEMENT SYSTEM BY UTSAV PANCHAL")
		self.root.geometry("1350x700+0+0")

		title = Label(self.root, text="MANAGEMENT SYSTEM BY UTSAV PANCHAL",bd=10, relief=GROOVE, font=("times new roman", 40, "bold"),bg="black", fg="white")
...
# =========MANAGE FRAME=====================================
		...
		lbl_Gender = Label(Manage_frame, text="Gender",bg="light blue", fg="black", font=("times new roman", 20, "bold"))
		...
		lbl_Contact= Label(Manage_frame, text="Contact",bg="light blue", fg="black", font=("times new roman", 20, "bold"))
		...
		lbl_Address= Label(Manage_frame, text="Address",bg="light blue", fg="black", font=("times new roman", 20, "bold"))
...
# =================BUTTON FRAME===============================
		...
		Addbtn=Button(btn_frame, text="Add", width=10, command=self.add_students ).grid(row=0, column=0, padx=10, pady=20)
		updatebtn=Button(btn_frame, text="Update", width=10, command=self.update_data ).grid(row=0, column=1, padx=10, pady=20)
		deletebtn=Button(btn_frame, text="Delete", width=10, command=self.delete_data ).grid(row=0, column=2, padx=10, pady=20)
		Clearbtn=Button(btn_frame, text="Clear", width=10, command=self.clear).grid(row=0, column=3, padx=10, pady=20)
...
# =========DETAIL FRAME=======================================
		...
		lbl_search = Label(Detail_frame, text="SEARCH BY",bg="light blue", fg="black", font=("times new roman", 20, "bold"))
...
#================TABLE FRAME===============================
	...
	def add_students(self):
		if self.Roll_no_var.get()=="" or self.name_var.get()=="" or self.gender_var.get()=="" or self.email_var.get()=="":
			...
			self.clear()
			con.close()
			messagebox.showinfo("Succes", "Data has been recorded")
